...
<div v-else-if="this.event.event == 'FundsRecalled'" align='right'><blocknum-output :blocknum='event.blockNumber' :timestamp='event.timestamp'></blocknum-output><br><div class='well well-sm' align='left' style='background-color:#dbdbff;display:inline-block;max-width:50%;'><eth-address-output :shorten-to=10 :address='event.args.contributor'></eth-address-output> recalled <ether-output :wei='event.args.amountReturned'></ether-output><span v-if='event.args.message.length>0'> and said:<div class="well well-sm" style='background-color:#ccccff;margin-top:10px;' v-html='formattedMessage'></div></span></div></div>
<div v-else-if="this.event.event == 'ContributorStatement'" align='right'><blocknum-output :blocknum='event.blockNumber' :timestamp='event.timestamp'></blocknum-output><br><div class='well well-sm' align='left' style='background-color:#dbdbff;display:inline-block;max-width:50%'><eth-address-output :shorten-to=10 :address='event.args.contributor'></eth-address-output> said: <div class='well well-sm' style='background-color:#ccccff;margin-top:10px;' v-html='formattedMessage'></div></div></div>
<div v-else-if="this.event.event == 'ProducerStatement'" align='left'><blocknum-output :blocknum='event.blockNumber' :timestamp='event.timestamp'></blocknum-output><br><div class='well well-sm' align='left' style='background-color:#ccffff;display:inline-block;max-width:50%'>Producer said: <div class='well well-sm' style='background-color:#afffff;margin-top:10px;' v-html='formattedMessage'></div></div></div>
