const MAINNET_CROWDSERVE_ADDRESS = "0x648967Cf9504a6EF19f2116fe5403088095BC9E5";
const MAINNET_EVENTSTART_BLOCKNR = 5140844;
const ROPSTEN_CROWDSERVE_ADDRESS = "0x2a998917e9e949e63da39b9269c523eb08eac26d";
const ROPSTEN_EVENTSTART_BLOCKNR = 2709613;
...
/////////////////Transaction/Function calls begin here////////////////////////////////////////////////////////
  ...
  window.csContract.setContributorStatement = (burnAmountInEth, statement) => {
    return new Promise((resolve, reject) => {
      CrowdServe.contributorStatement(web3.toWei(burnAmountInEth), statement, (err,res) => {
        if(err){
          reject(err);
        } else{
          resolve(res);
